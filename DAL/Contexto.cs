...
namespace HermanosApi.DAL
{
    public class Contexto: DbContext
    {
        public DbSet<Hermanos> Hermanos { get; set;}
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder){
            ...
            modelBuilder.Entity<Hermanos>().HasData(
